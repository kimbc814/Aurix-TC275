...
void initGpt12Timer(void)
{
    ...
    IfxPort_setPinModeOutput(logic_1, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
...
void interruptGpt12(void)
{
    ...
    time_count++;
    IfxPort_setPinLow(logic_1);
    IfxPort_setPinHigh(logic_1);
