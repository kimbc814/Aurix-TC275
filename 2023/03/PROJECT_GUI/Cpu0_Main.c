...
int core0_main(void)
{
    ...
    while(1)
    {
        ...
        input_num1=receive_ASCLIN_UART_message();
        //change_rdata_type(input_num1);
        change_rdata_type1(input_num1);
        LED_ONOFF();
        adc_value = indicateConversionValue();
        send_ASCLIN_UART_message(input_num1,adc_value);
