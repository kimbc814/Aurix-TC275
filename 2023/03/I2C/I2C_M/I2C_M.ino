...
#define inturrupt_timeer0 45
#define inturrupt_timeer1 49
#define inturrupt_timeer2 50
#define inturrupt_timeer3 47
...
void setup() {
  //pin 설정
  pinMode(inturrupt_timeer0,OUTPUT);
  pinMode(inturrupt_timeer1,OUTPUT);
  pinMode(inturrupt_timeer2,OUTPUT);
  pinMode(inturrupt_timeer3,OUTPUT);
  //mstimer시작
  MsTimer2::set(100,TX);
  MsTimer2::set(30,I2C);
  // Wire 라이브러리 초기화
...
void send_input_data(void)
{
  ...
  protocal_test[5] = (char)adc11;
  protocal_test[6] = (char)adc22;
////////////////////////////////////////////////////////////////
...
void CALL_ADC(){
    ...
    adc22 = Wire.read();
      ...
      Serial.print("adc2 : ");
      Serial.println(adc22);
      Serial.println(adc22*256+adc11);
      Serial.println();*/
      delay(10);
  }
void CALL_LED(){
...
void loop() {
    ...
    digitalWrite(inturrupt_timeer0, HIGH);
    SW_IN = Serial1.read();
    //Serial.print(SW_IN);
    //Serial.println();
    digitalWrite(inturrupt_timeer0, LOW);
    }
    digitalWrite(inturrupt_timeer1, HIGH);
    CALL_ADC();
    digitalWrite(inturrupt_timeer1, LOW);
    digitalWrite(inturrupt_timeer2, HIGH);
    CALL_LED();
    digitalWrite(inturrupt_timeer2, LOW);
    digitalWrite(inturrupt_timeer3, HIGH);
    send_input_data();
    digitalWrite(inturrupt_timeer3, LOW);
    flag =0;
    }
  }
